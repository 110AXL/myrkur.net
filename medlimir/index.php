	...
	if(isset($_SESSION["loggedin"]) && $_SESSION["loggedin"] === true){
		...
		if ($result2->num_rows > 0) {
			...
			while($row = $result2->fetch_assoc()) {
				...
				if($row["album"] == NULL)
					echo "<a target=_blank title='" . $row["artist"] . "' href=" . $row["link1"]. "><img width=200 height=200 src=" . $removed_spaces . " /></a>";
				else
			...
			while($row = $result3->fetch_assoc()) {
				...
				if($row["album"] == NULL)
					echo "<a target=_blank title=DELETE '" . $row["artist"] . "' href=delete.php?album=" . $row["album"]. "><img width=100 height=100 src=" . $resized_link . " /></a>";
				else
					$artist = htmlspecialchars($row['artist']);
				echo $artist;
					echo "<a target=_blank title='DELETE " . $row["artist"]. " - " . $row["album"]. "' href=delete.php?artist='"; echo $artist . "'&album='" . $row["album"]. "'><img width=100 height=100 src=" . $resized_link . " /></a>";
			}*/
