	...
	if(isset($_SESSION["loggedin"]) && $_SESSION["loggedin"] === true){
		...
		if ($result2->num_rows > 0) {
			...
			while($row = $result2->fetch_assoc()) {
				...
				if(!$row["album"] == NULL)
					echo "<a target=_blank title='" . $row["artist"]. " - " . $row["album"]. "' href='" . $row["link1"]. "'><img width=200 height=200 onError='this.onerror=null;this.src=/res/noid.jpg' src=/uploads/" . $removed_spaces . " /></a>";
			}
		echo "</body>";
		}
	$mysqli->close();
