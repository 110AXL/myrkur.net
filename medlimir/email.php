...
$ip = "185.224.138.100";           // should be server IP address or 127.0.0.1 if local server
$account = "benediktivars@gmail.com";        // cpanel user account name
$passwd ="AXL110axl";        // cpanel user password
$port =2083;                 // cpanel secure authentication port unsecure port# 2082

$email_domain = 'myrkur.net'; // email domain (usually same as cPanel domain)
