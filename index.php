      ...
      <?php
        ...
        if ($result->num_rows > 0) {
         ...
         while($row = $result->fetch_assoc()) {
           ...
           echo "<p class='info' title='Year & link clicks.'><a href=main/link.php?i='" . $row["id"]."'>" . $row["year"] . "</p> <p style=background-color:#111;font-size:8px;>" . $row["clicks"] . "</h4></a></p>" . $row["username"] ."</div>";
           }
         }
